...
export const TRADING_FEE_DENOMINATOR = 1000;
export const OWNER_TRADING_FEE_NUMERATOR = 5;
export const OWNER_TRADING_FEE_DENOMINATOR = 1000;
export const OWNER_WITHDRAW_FEE_NUMERATOR = SWAP_PROGRAM_OWNER_FEE_ADDRESS ? 0 : 1;
export const OWNER_WITHDRAW_FEE_DENOMINATOR = SWAP_PROGRAM_OWNER_FEE_ADDRESS ? 0 : 1000;
export const HOST_FEE_NUMERATOR = 20;
export const HOST_FEE_DENOMINATOR = 1000;
